...
**Plans:** 3 plans
Plans:
- [ ] 03-01-PLAN.md — Particle texture (BootScene) and VFX config (GameConfig.js)
- [ ] 03-02-PLAN.md — GameScene VFX: death bursts, build sparkle, core shockwave
...
| 3. Juicy Combat | 0/3 | Not started | - |
