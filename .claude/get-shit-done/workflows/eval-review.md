...
```bash
AUDITOR_MODEL=$(node "/Users/machado/Projects/bug-siege/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /Users/machado/Projects/bug-siege/.claude/agents/gsd-eval-auditor.md for instructions.
