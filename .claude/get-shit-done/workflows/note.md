...
- **Global scope**: `/Users/machado/Projects/bug-siege/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/machado/Projects/bug-siege/.claude/notes/`)
...
2. Glob `/Users/machado/Projects/bug-siege/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/machado/Projects/bug-siege/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/machado/Projects/bug-siege/.claude/notes/` — works in any directory
