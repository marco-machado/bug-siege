...
<reference>
@/Users/machado/Projects/bug-siege/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/machado/Projects/bug-siege/.claude/get-shit-done/references/user-profiling.md` to load:
