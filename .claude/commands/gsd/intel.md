...
Intel system is disabled. To activate:
  ...
  node /Users/machado/Projects/bug-siege/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/machado/Projects/bug-siege/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/machado/Projects/bug-siege/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/machado/Projects/bug-siege/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
